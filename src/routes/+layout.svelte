...
<div class="grid min-h-dvh grid-rows-[minmax(0,1fr)_auto] bg-background text-foreground">
	...
	<footer class="border-t border-border bg-card">
		<div
			class="mx-auto flex w-full max-w-7xl items-center justify-between gap-3 px-4 py-1.5 text-[10px] leading-tight text-muted-foreground sm:px-6 sm:py-2 sm:text-[11px]"
		>
			<p>Built {builtAt}</p>
			<p class="ml-auto flex items-center gap-1">
