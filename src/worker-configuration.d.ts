/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 7b8b0e2f4471d4f1d9452b81dd159b94)
...
interface __BaseEnv_Env {
	...
	RECEPIENT_NAME_THAI: string;
	RECEPIENT_NAME_ENG: string;
	RECEPIENT_EXPECTED_PROXY: string;
	RECEPIENT_EXPECTED_PROXY_VALUE_ENDING: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_GOOGLE_OAUTH_CLIENT_ID" | "GOOGLE_OAUTH_CLIENT_SECRET" | "SLIP_OK_API_KEY" | "SLIP_OK_API_ENDPOINT" | "RECEPIENT_NAME_THAI" | "RECEPIENT_NAME_ENG" | "RECEPIENT_EXPECTED_PROXY" | "RECEPIENT_EXPECTED_PROXY_VALUE_ENDING">> {}
}
