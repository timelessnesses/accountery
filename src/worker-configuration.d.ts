/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: ab1027530cb9198d34d3458d6a00816b)
// Runtime types generated with workerd@1.20260617.1 2026-06-21 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	AccountingReceipts: R2Bucket;
	AccountingDatabase: D1Database;
	SharedSecrets: SecretsStoreSecret;
	ASSETS: Fetcher;
	PUBLIC_GOOGLE_OAUTH_CLIENT_ID: string;
	GOOGLE_OAUTH_CLIENT_SECRET: string;
	SLIP_OK_API_KEY: string;
	SLIP_OK_API_ENDPOINT: string;
	PUBLIC_RECEPIENT_EXPECTED_PROXY: string;
	PUBLIC_RECEPIENT_EXPECTED_PROXY_VALUE_ENDING: string;
	PUBLIC_RECEPIENT_NAME_ENG: string;
	PUBLIC_RECEPIENT_NAME_THAI: string;
	ADMIN_EMAIL: string;
	PUBLIC_ORGANIZATION_DOMAIN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_GOOGLE_OAUTH_CLIENT_ID" | "GOOGLE_OAUTH_CLIENT_SECRET" | "SLIP_OK_API_KEY" | "SLIP_OK_API_ENDPOINT" | "PUBLIC_RECEPIENT_EXPECTED_PROXY" | "PUBLIC_RECEPIENT_EXPECTED_PROXY_VALUE_ENDING" | "PUBLIC_RECEPIENT_NAME_ENG" | "PUBLIC_RECEPIENT_NAME_THAI" | "ADMIN_EMAIL" | "PUBLIC_ORGANIZATION_DOMAIN" | "AUTHENTICATION_METHOD">> {}
}
